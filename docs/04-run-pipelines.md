...
lab:
    ...
    description: 'Run pipelines in Azure Machine Learning.'
    level: 300
    duration: 45 minutes
---
...
1. Wait for the script to complete - this typically takes around 5-10 minutes.
    ...
    <ol>
        ...
        <li>Download the training data from https://https://github.com/vincentgiraud/demo-mlops/raw/refs/heads/main/data/diabetes-data/diabetes.csv</li>
...
1. Open the **experimentation/Run a pipeline job.ipynb** notebook.
